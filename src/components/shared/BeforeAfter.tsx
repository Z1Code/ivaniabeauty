...
export default function BeforeAfter() {
  ...
  return (
    <motion.div
      ref={containerRef}
      className="relative aspect-[3/4] w-full select-none overflow-hidden rounded-xl"
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {/* "Sin Faja" label */}
        <span className="absolute bottom-4 left-4 rounded-full bg-white/80 px-4 py-1.5 text-sm font-medium text-gray-700 shadow-sm backdrop-blur-sm">
      ...
      >
        ...
        {/* "Con Faja" label */}
        <span className="absolute right-4 bottom-4 rounded-full bg-white/80 px-4 py-1.5 text-sm font-medium text-rosa-dark shadow-sm backdrop-blur-sm">
          {t("beforeAfter.with")}
        </span>
      </div>
