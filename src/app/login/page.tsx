...
export default function LoginPage() {
  ...
  const { user, initialized, signInWithEmail, signInWithGoogle, signInWithApple, resetPassword } = useAuth();
        ...
        <div className="bg-white rounded-2xl shadow-lg shadow-rosa/5 p-8 md:p-10">
          ...
          {resetSent && (
            <motion.div
              initial={{ opacity: 0, y: -8 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-5 p-3 rounded-xl bg-green-50 border border-green-200 text-green-700 text-sm text-center"
            >
              {t("auth.resetSent")}
            </motion.div>
          )}
          ...
          {showReset ? (
            ...
            <form onSubmit={handleResetPassword} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 bg-gray-50/50 text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-rosa/30 focus:border-rosa transition-all"
              ...
              <button
                ...
                className="w-full py-3 rounded-full bg-rosa hover:bg-rosa-dark text-white font-medium text-sm transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 cursor-pointer"
              >
                {resetLoading ? (
              ...
              <button
                ...
                className="w-full text-sm text-gray-500 hover:text-rosa transition-colors cursor-pointer"
              >
                {t("auth.signIn")}
              </button>
            </form>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <button
                      ...
                      className="text-xs text-rosa hover:text-rosa-dark transition-colors cursor-pointer"
                    >
